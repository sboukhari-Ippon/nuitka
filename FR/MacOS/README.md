...
1. **Installe** — une commande, zéro `chmod`, aucune installation de Python :
   `sh install.sh` (prérequis Homebrew, droits, quarantaine Gatekeeper levée). Harness manquant ? `INSTALL.md`.
2. **Ouvre l'app** : double-clique sur `MAIsterMind.app` — le navigateur s'ouvre seul.
